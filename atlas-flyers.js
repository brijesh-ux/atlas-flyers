...
var CAT_SIDEBAR_HIDE = "#searchspring-sidebar,#facetedSearch,.facetedSearch,.ss__sidebar,.floating-filter-btn,.floating-mobile-filter-btn,.ssc-slideout-button{display:none!important}";
  ...
  try{
    ...
    (async function(){
      try{
        ...
        if(facets){ssBuildFilterBar(facets);fpFilterFloat();}
      }catch(e){}
    })();
