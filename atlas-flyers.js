        ...
        if(ssPage===1){
          ...
          try{
            ...
            ((mc&&mc.inline)||[]).forEach(function(en){
              ...
              tile.className='fp-merch-tile';
              tile.innerHTML=html;
              [].slice.call(tile.querySelectorAll('script')).forEach(function(sx){sx.parentNode.removeChild(sx);});
              if(tile.querySelector('img'))wrap.appendChild(tile);
            });
          }catch(e){}
          if(!res.length){
